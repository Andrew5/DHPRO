...
- (HLPrinter *)getPrinter
{
    ...
    [printer appendText:@"地址:北京清华大学旁小食堂地下一楼左拐222室" alignment:HLTextAlignmentLeft];
    ...
    [printer appendText:@"位图方式二维码" alignment:HLTextAlignmentLeft];
    [printer appendQRCodeWithInfo:@"www.baidu.com"];
//    [printer appendQRCodeWithInfo:@"www.baidu.com" size:10];

//    [printer appendImage:[UIImage imageNamed:@"ico180"] alignment:HLTextAlignmentCenter maxWidth:100];


    
    [printer appendSeperatorLine];
    [printer appendText:@"指令方式二维码2" alignment:HLTextAlignmentCenter];
    [printer appendQRCodeWithInfo:@"www.baidu.com" size:10];

    [printer appendFooter:nil];
    [printer appendImage:[UIImage imageNamed:@"ico180"] alignment:HLTextAlignmentCenter maxWidth:200];
