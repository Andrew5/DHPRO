...
- (BOOL)isTouchIdEnabledOrNotBySystem
{
    ...
    else
    {
		...
		NSLog(@"---%li---%@--%@---%@--%@--%@",(long)authError.code,authError.domain,authError.userInfo,authError.localizedDescription,authError.localizedFailureReason,authError.localizedRecoveryOptions);
        return NO;
    }
#else
    /**
