...
#import "RegionView.h"
#import "RegionMode.h"
@interface AddressEdiViewController ()<RefionViewDelegate>
{
    NSString * m_cityPid;
...
@implementation AddressEdiViewController
...
- (void)viewDidLoad {
    ...
    self.deletwBtn.frame = CGRectMake(20,CGRectGetMaxY(self.TableView.frame)+30,CGRectGetWidth(self.view.frame)-40, 40);
    ...
    [self.deletwBtn setTitle:@"设置为默认地址" forState:UIControlStateNormal];
    [self.deletwBtn setBackgroundColor:[UIColor colorWithRed:0.01 green:0.77 blue:0.51 alpha:1.0]];
    [self.deletwBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
//            _cell.textLabel.text = @"地址:";
            ...
            img.frame = CGRectMake(65, 12, 8, 8);
            self.provincebutt = [UIButton buttonWithType:UIButtonTypeCustom];
            self.provincebutt.frame = CGRectMake(20, 10, 80, 30);
            ...
            img1.frame = CGRectMake(65, 12, 8, 8);
            self.citybutt = [UIButton buttonWithType:UIButtonTypeCustom];
            self.citybutt.frame = CGRectMake(120, 10, 80, 30);
            ...
            img2.frame = CGRectMake(65, 12, 8, 8);
            self.districtbutt = [UIButton buttonWithType:UIButtonTypeCustom];
            self.districtbutt.frame = CGRectMake(220, 10, 80, 30);
...
-(void)buttClick:(UIButton *)sender
{
    switch (sender.tag) {
        case 100:
        {
            self.citybutt.hidden = YES;
            self.districtbutt.hidden = YES;
            self.citybutt.titleLabel.text = @"请选择";
            self.districtbutt.titleLabel.text = @"请选择";
            self.m_RegionView.frame = CGRectMake(20, 192, 80, 150);
        ...
        case 101:
        {
            self.districtbutt.hidden = YES;
            self.districtbutt.titleLabel.text = @"请选择";
            self.m_RegionView.frame = CGRectMake(120, 192, 80, 150);
        ...
        case 102:
        {
            ...
            self.m_RegionView.frame = CGRectMake(220, 192, 80, 150);
