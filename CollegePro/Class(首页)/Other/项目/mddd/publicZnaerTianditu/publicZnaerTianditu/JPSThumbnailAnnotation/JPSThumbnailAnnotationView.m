...
- (void)updateWithThumbnail:(JPSThumnail *)thumbnail {
    ...
    int gender = [[thumbnail.info objectForKey:@"gender"]intValue];
    NSString *placeHolderHead = (gender == SEXMAN ? @"user_man.png" : @"user_woman.png");
    
    NSString *imageUrl = [BaseHandler retImageUrl:[thumbnail.info objectForKey:@"equipIcon"]];
    [self.imageView setImageWithURL:[NSURL URLWithString:imageUrl] placeholderImage:[UIImage imageNamed:placeHolderHead]];
}
