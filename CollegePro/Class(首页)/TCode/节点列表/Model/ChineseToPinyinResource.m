...
- (void)initializeResource {
    ...
    if (dataMap) {
        ...
        [self cacheObjec:_unicodeToHanyuPinyinTable forKey:kCacheKeyForUnicode2Pinyin];
    }
}
...
- (NSString *)getHanyuPinyinRecordFromCharWithChar:(unichar)ch {
    ...
    NSString *foundRecord =[_unicodeToHanyuPinyinTable objectForKey:codepointHexStr];
