...
@implementation TableViewAnimationA
...
+ (void)moveAnimationWithTableView:(UITableView *)tableView {
    ...
    for (int i = 0; i <cells.count; i++) {
        ...
        cell.transform = CGAffineTransformMakeTranslation(-DH_DeviceWidth, 0);
...
+ (void)fallAnimationWithTableView:(UITableView *)tableView {
    ...
    for (int i = 0; i <cells.count; i++) {
        UITableViewCell *cell = [tableView.visibleCells objectAtIndex:i];
        cell.transform = CGAffineTransformMakeTranslation(0, - DH_DeviceHeight);
...
+ (void)springListAnimationWithTableView:(UITableView *)tableView {
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        cell.layer.transform = CATransform3DMakeTranslation(0, -DH_DeviceHeight, 20);
