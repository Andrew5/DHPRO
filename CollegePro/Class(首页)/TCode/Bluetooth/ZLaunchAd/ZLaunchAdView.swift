...
//            NotificationCenter.default.addObserver(forName: UIApplication.NSNotification.Name.UIApplicationWillEnterForeground, object: nil, queue: nil) { _ in
//                /// 上次出现的时间戳
...
//                }
//            }
//            NotificationCenter.default.addObserver(forName: UIApplication.NSNotification.Name.UIApplicationDidEnterBackground, object: nil, queue: nil) { (_) in
//                /// 记录时间戳
