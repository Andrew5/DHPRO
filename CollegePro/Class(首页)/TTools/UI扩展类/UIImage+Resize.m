...
static inline CGFloat DegreesToRadiansA(CGFloat degrees)
{
...
- (UIImage *)rotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(DegreesToRadiansA(degrees));
    ...
    CGContextRotateCTM(bitmap, DegreesToRadiansA(degrees));
