...
/**
 *
 * 使用方法  CGPoint point = CGPointMake(22+sender.frame.origin.x + sender.frame.size.width/2, 270+50);
 ...
 _volumeStr = titles[index];
 if (self.courseStr != nil) {
 NSString *str = [self.courseStr  stringByAppendingString:self.volumeStr];
